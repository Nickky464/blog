<template>
  ...
  <section>
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div v-for="(blog, index) in blogs.slice(-3)" :key="blog.id" class="carousel-item"
  ...
  <!-- Blog section -->
  <section id="blog">
    <h1 class="text text-center my-4 "><span class="text-danger">All</span>Blog</h1>
    <h2 class="text-center text my-4">
      <TypedJSWelcome />
    </h2>
    <div class="container">
